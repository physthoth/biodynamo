...
function InstallPackages {
  ...
  if [ $INSTALL ]; then
    ...
    sudo ln -sf /usr/lib64/libICE.so.6 /usr/lib64/libICE.so
    sudo ln -sf /usr/lib64/libSM.so.6 /usr/lib64/libSM.so
    sudo ln -sf /usr/lib64/libXt.so.6 /usr/lib64/libXt.so
    sudo ln -sf /usr/lib64/libXpm.so.4 /usr/lib64/libXpm.so
